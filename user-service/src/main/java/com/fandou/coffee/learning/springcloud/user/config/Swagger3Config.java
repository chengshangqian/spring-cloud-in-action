...
public class Swagger3Config {
    ...
    public Docket restApiDocket() {
        ...
        return new Docket(DocumentationType.OAS_30) // 2.x版本的文档类型为DocumentationType.SWAGGER_2
                ...
                // 扫描包路径类方式
                .apis(RequestHandlerSelectors.basePackage("com.fandou.coffee.learning.springcloud.user.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("用户服务API文档")
                .description("包括基本的增删改查用户服务API、角色服务API以及认证登录服务API，目前处于1.0版本，后续会有更多的API上线，敬请关注！")
                .version("1.0")
                .build();
    }
}
