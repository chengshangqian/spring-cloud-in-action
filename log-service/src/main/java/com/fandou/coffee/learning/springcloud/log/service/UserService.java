...
import com.fandou.coffee.learning.springcloud.log.service.impl.UserServiceMock;
...
public interface UserService {
    ...
    HttpResult<User> getUser(@RequestHeader(value = "Authorization") String accessToken, @PathVariable("username") String username);
}
